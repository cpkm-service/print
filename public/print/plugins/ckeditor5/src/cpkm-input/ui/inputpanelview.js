...
import CpkmInputFormRowView from './inputformrowview';
 ...
 */
export default class CpkmInputPanelView extends View {
    /**
    ...
    constructor(locale, integrations = {}) {
        ...
        for (const [integration, integrationView] of Object.entries(integrations)) {
            if (integration === 'insertInputWidth') {
                integrationView.fieldView
                    .bind('value').to(this, 'InputWidthValue', (value) => value || '');
                integrationView.fieldView.on('input', () => {
                    this.InputWidthValue = integrationView.fieldView.element.value.trim();
                });
            }
        ...
        this.setTemplate({
            ...
            children: [
                ...this._integrations,
                new CpkmInputFormRowView(locale, {
                    children: [
    ...
    _createActionButtons(locale) {
        ...
        insertButtonView.set({
            ...
            type: 'submit',
            withText: true,
            isEnabled: this.InputWidthValue
        });
        ...
        insertButtonView.bind('isEnabled').to(this, 'InputWidthValue', value => !!value);
